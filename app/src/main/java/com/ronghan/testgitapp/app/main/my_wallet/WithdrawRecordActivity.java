...
public class WithdrawRecordActivity extends BaseActivity {
    ...
    protected void onResume() {
        ...
        jO.put("userId", MSPUtils.getInstance(WithdrawRecordActivity.this).getLoginSp().id);
        jO.put("page", 1);
        jO.put("pageSize", 10);
    ...
    private void httpTransferRecordPagination(JSONObject jO) {
        HttpMethods.getInstance().transferRecordPagination(new ProgressSubscriber(transferRecordPaginationListener, WithdrawRecordActivity.this, "正在查询…", true), jO);
    }
}
