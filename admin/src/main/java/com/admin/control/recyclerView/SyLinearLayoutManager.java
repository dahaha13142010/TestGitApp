...
/**
 * 项目名称：JKPay
 * 类描述： recycerView 随item高度变化而变化
 * 创建人：Michael
 * 创建时间：2015/12/25 15:19
 * 修改人：Michael
 * 修改时间：2015/12/25 15:19
 * 修改备注：
 */
public class SyLinearLayoutManager extends LinearLayoutManager {
    ...
    public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int widthSpec, int heightSpec) {
        ...
        ABLogUtil.d("state:" + state.toString());
...
//                    width = widthSize;
        ...
        setMeasuredDimension(widthSpec, height > heightSize ? heightSize : height);
